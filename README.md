...
I'm a Computer Engineering senior student (CGPA: 3.91/4.00, Dean's List x3) at the **University of Sharjah** and a RISE-funded Research Assistant working on UAV-assisted Integrated Sensing and Communications (ISAC) and 5G/B5G systems. My experience spans wireless systems, digital signal processing, and hardware design.

Currently seeking a **Summer 2026 engineering internship** in telecommunications, radar, DSP, or AI-enabled engineering to apply my technical problem-solving skills to real-world projects.
...
- [**📻 AM Radio Modulation & Demodulation transceiver**](https://github.com/IamOumarIbrahim/am-modulation-demodulation-matlab)  
  A complete end-to-end AM communication transceiver chain simulated in MATLAB—from voice capturing to coherent demodulation using a 5th-order Butterworth LPF.
- [**🥤 6-Choice Vending Machine pure TTL hardware**](https://github.com/IamOumarIbrahim/ttl-vending-machine)  
  A fully functional, hardware-implemented juice vending machine designed and built from scratch using 50+ discrete TTL logic ICs (no microcontrollers).
- [**☀️ Grid-Connected Solar PV Design & Analysis**](https://github.com/IamOumarIbrahim/solar-pv-system-design)  
